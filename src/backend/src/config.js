...
config.static_hosting_domain = 'forkware.site';
...
config.title = 'Forkware - The Internet OS';
config.short_description = 'Forkware is an Internet OS that keeps all your stuff in one place. Create, edit, and share directly in your browser.';
config.long_description = 'Forkware is a cloud desktop that keeps all your apps, files, games in one place, accessible from anywhere.';
config.company = 'Forkware Technologies Inc.';
...
config.contact_email = 'hi@forkware.com';
config.email_sender = process.env.EMAIL_SENDER || 'Forkware <noreply@forkware.com>';
...
config.domain = process.env.DOMAIN || 'forkware.localhost';
