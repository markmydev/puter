...
If this was not you, please contact support@forkware.io immediately.
</p>
        `,
    },
    'password_change_notification': {
        ...
        support@forkware.io immediately.
        </p>
        `,
    },
    ...
    'enabled_2fa': {
        ...
        on your account</p>
        <p>If you did not perform this action please contact support@forkware.io
        immediately</p>
        <p>Sincerely,</p>
        <p>Puter</p>
        `
    ...
    'share_by_username': {
        ...
        <p>Go to forkware.io to check it out.</p>
        {{#if message}}
    ...
    */
    async send_email (user, template, values) {
        ...
        transporter.sendMail({
            from: '"Forkware" no-reply@forkware.com', // sender address
