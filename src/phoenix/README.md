...
`phoenix` is a pure-javascript shell built for [forkware.io](https://forkware.io).
...
You can use the [terminal on Puter](https://forkware.io/app/terminal), including self-hosted installations.
