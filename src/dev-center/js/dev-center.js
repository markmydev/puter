...
let domain = 'forkware.io', authUsername;
let source_path
let apps = [];
...
$(document).ready(function () {
    ...
    setTimeout(async function () {
        ...
        // Get dev profile. This is only for forkware.io for now as we don't have dev profiles in self-hosted Puter
        if(domain === 'forkware.io'){
...
async function create_app(title, source_path = null, items = null) {
    ...
    puter.apps.create({
            title: title,
            name: name,
            indexURL: 'https://dev-center.forkware.io/coming-soon.html',
            icon: icon,
            description: ' ',
        ...
        .then(async (app) => {
            ...
            puter.apps.update(app.name, {
                title: title,
                indexURL: source_path ? protocol + `://${subdomain}.` + static_hosting_domain : 'https://dev-center.forkware.io/coming-soon.html',
                icon: icon,
                description: ' ',
                maximizeOnStart: false,
                background: false,
