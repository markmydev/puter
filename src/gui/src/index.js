 ...
 * @param {string} [options.gui_origin='https://forkware.io'] - The origin URL for the GUI.
 * @param {string} [options.api_origin='https://api.forkware.io'] - The origin URL for the API.
...
window.gui = async function(options){
    ...
    window.gui_origin = options.gui_origin ?? options.app_origin ?? `https://forkware.io`;
    ...
    window.api_origin = options.api_origin ?? "https://api.forkware.io";
    ...
    // note: Build script will prepend `window.gui_env="prod"` to the top of the file
        ...
        await window.loadScript('https://js.forkware.io/v2/');
