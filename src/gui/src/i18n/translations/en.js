...
const en = {
    ...
    dictionary: {
        ...
        from: "From",
        general: "General",
        get_a_copy_of_on_puter: `Get a copy of '%%' on Forkware.com!`,
        ...
        puter_description: `Forkware is a privacy-first personal cloud to keep all your files, apps, and games in one secure place, accessible from anywhere at any time.`,
        reading: "Reading %strong%",
        writing: "Writing %strong%",
        recent: "Recent",
        recommended: "Recommended",
        recover_password: "Recover Password",
        refer_friends_c2a: "Get 1 GB for every friend who creates and confirms an account on Forkware. Your friend will get 1 GB too!",
        refer_friends_social_media_c2a: `Get 1 GB of free storage on Forkware.com!`,
        refresh: 'Refresh',
