...
const it = {
  ...
  dictionary: {
    ...
    from: "Da",
    general: "Generale",
    get_a_copy_of_on_puter: `Ottieni una copia di '%%' su forkware.io!`,
    ...
    refer_friends_social_media_c2a: `Ottieni 1GB di spazio di spazio di archiviazione gratuito su forkware.io!`,
    refresh: "Ricarica",
