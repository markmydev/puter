...
window.initgui = async function(options){
    ...
    // i.e. https://forkware.io/app/<app_name>/?puter.fullpage=true
    //--------------------------------------------------------------------------------------
    ...
    // i.e. https://forkware.io/?embedded_in_popup=true
    //--------------------------------------------------------------------------------------
    ...
    // i.e. https://forkware.io/?r=123456
    //--------------------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------------------
        ...
        if(whoami){
            ...
            // if user is logging in using an auth token that means it's not their first ever visit to forkware.io
    ...
    // i.e. https://forkware.io/?share_token=<share_token>
    //--------------------------------------------------------------------------------------
    ...
    if(window.feature_flags.prompt_user_when_navigation_away_from_forkware){
    ...
    document.addEventListener("visibilitychange", (event) => {
        if (document.visibilityState !== "visible") {
            ...
            document.title = window.doc_title_before_blur ?? 'Forkware';
        }
    });
