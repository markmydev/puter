...
async function UIDesktop(options){
    ...
    ht += `<div class="toolbar" style="height:${window.toolbar_height}px; min-height:${window.toolbar_height}px; max-height:${window.toolbar_height}px;">`;
        // logo
        ht += `<div class="toolbar-btn toolbar-puter-logo" title="Puter" style="margin-left: 10px;"><img src="/src/images/logo.png" draggable="false" style="display:block; width:17px; height:17px"></div>`;
    ...
    // i.e. https://forkware.io/app/<app_name>
    //--------------------------------------------------------------------------------------
    if(window.url_paths[0]?.toLocaleLowerCase() === 'app' && window.url_paths[1]){
    ...
    // i.e. https://forkware.io/@<username>
    //--------------------------------------------------------------------------------------
