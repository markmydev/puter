...
window.feature_flags = {
    ...
    // if true, the user will be asked to confirm before navigating away from Forkware only if there is at least one window open
    prompt_user_when_navigation_away_from_forkware: false,
