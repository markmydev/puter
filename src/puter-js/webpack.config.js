...
export default {
  ...
  plugins: [
    new webpack.DefinePlugin({
      'globalThis.PUTER_ORIGIN': JSON.stringify(process.env.PUTER_ORIGIN || 'https://forkware.io'),
      'globalThis.PUTER_API_ORIGIN': JSON.stringify(process.env.PUTER_API_ORIGIN || 'https://api.forkware.io'),
    }),
  ],
};
