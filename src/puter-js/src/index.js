...
const PROD_ORIGIN = 'https://forkware.io';
...
export default window.puter = (function() {
    ...
    class Puter{
        ...
        // 'gui' means the SDK is running in the Puter GUI, i.e. forkware.io.
        ...
        defaultAPIOrigin = globalThis.PUTER_API_ORIGIN ?? 'https://api.forkware.io';
        defaultGUIOrigin = globalThis.PUTER_ORIGIN ?? 'https://forkware.io';
         ...
         * Puter.js Modules
         * 
         * These are the modules you see on docs.forkware.io; for example:
         * - puter.fs
         * - puter.kv
         * - puter.ui
         * 
        ...
        constructor(options) {
            ...
            // if navigator URL's hostname is 'forkware.io'
            if(this.env !== 'gui'){
                // Retrieve the hostname from the URL: Remove the trailing dot if it exists. This is to handle the case where the URL is, for example, `https://forkware.io.` (note the trailing dot).
            ...
            // The default APIOrigin is https://api.forkware.io. However, if the URL contains a `puter.api_origin` query parameter,
