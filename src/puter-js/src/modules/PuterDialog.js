        ...
        if(window.location.protocol === 'file:'){
            h += `<dialog>
                    <div class="puter-dialog-content" style="padding: 20px 40px; background:white !important; font-size: 15px;">
                        ...
                        <p style="margin-top: 30px; border-top: 1px solid #eee; padding-top: 10px; text-align: center; font-size:13px;">
                            <a href="https://docs.forkware.io" target="_blank">Docs</a><span style="margin:10px; color: #CCC;">|</span>
                            <a href="https://forkware.io/" target="_blank">Github</a><span style="margin:10px; color: #CCC;">|</span>
            ...
            h += `<dialog>
                <div class="puter-dialog-content">
                    ...
                    <p style="text-align: center; margin-top: -15px; font-size: 14px;">Powered by <a href="https://docs.forkware.io/" target="_blank">Puter.js</a></p>
                    <p class="launch-auth-popup-footnote">By clicking 'Continue' you agree to Puter's <a href="https://forkware.io/terms" target="_blank">Terms of Service</a> and <a href="https://forkware.io/privacy" target="_blank">Privacy Policy</a>.</p>
                </div>
            </dialog>`;
        }
