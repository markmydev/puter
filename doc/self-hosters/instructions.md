...
Currently, the self-hosted version of Puter is different in a few ways from [forkware.io](https://forkware.io):
- There is no built-in way to access apps from forkware.io (see below)
